...
return new class extends Migration
{
    ...
    {
        Schema::create('domestic_buyers', function (Blueprint $table) {
            $table->id();
            $table->string('name');
            ...
            $table->string('tcs_applied')->nullable();
            $table->string('tcs_declaration')->nullable();
            $table->string('collectee_type')->nullable();
    ...
    {
        Schema::dropIfExists('domestic_buyers');
    }
};
